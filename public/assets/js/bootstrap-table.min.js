...
!(function (t, e) {
    ...
    var Yt = Y,
        ...
        ae = function (t) {
            return (
                "Symbol(" + (void 0 === t ? "" : t) + ")_" + oe(++ie + ne, 36)
            );
        },
        re = p,
        se = Ht.exports,
            ...
            ? function (t, e, i) {
                  if (
                      ...
                      n &&
                          ...
                          (i = {
                              configurable:
                                  oi in i ? i.configurable : n.configurable,
        ...
        nn = (ci.exports = function (t, e, i) {
            "Symbol(" === String(e).slice(0, 7) &&
                ...
                (!Gi(t, "name") || (Yi && t.name !== e)) &&
                    (Ki
                        ? Zi(t, "name", { value: e, configurable: !0 })
                        : (t.name = e)),
                tn &&
                    i &&
                    Gi(i, "arity") &&
            ...
            return (
                Gi(n, "source") ||
                    (n.source = en.join("string" == typeof e ? e : "")),
                t
            );
        });
                ...
                for (n in e) {
                    if (
                        ...
                        (o = t.dontCallGetSet
                            ? (r = oo(i, n)) && r.value
                            : i[n]),
                        !co(l ? n : s + (c ? "." : "#") + n, t.forced) &&
                            void 0 !== o)
                    ) {
                        if (typeof a == typeof o) continue;
                        lo(a, o);
                    }
                    (t.sham || (o && o.sham)) && ao(a, "sham", !0),
                        ro(i, n, a, t);
                }
        },
        uo = jn,
    ...
    va.f =
        ba && !ma
            ...
            : function (t, e) {
                  wa(t);
                  for (
                      var i, n = Sa(e), o = xa(e), a = o.length, r = 0;
                      a > r;
    ...
    var Gs = b,
        ...
        Zs = function (t) {
            return function (e) {
                for (
                    var i, n = Js(e), o = Ys(n), a = o.length, r = 0, s = [];
                    a > r;

                )
                    (i = o[r++]),
                        (Gs && !Xs(n, i)) || Qs(s, t ? [i, n[i]] : n[i]);
                return s;
            };
        },
    ...
    var Mc = At,
        ...
        Gc = function (t, e) {
            ...
            return i < 8
                ? Kc(t, e)
                : Yc(t, Gc(qc(t, 0, n), e), Gc(qc(t, n), e), e);
        },
        Kc = function (t, e) {
            ...
            return [
                ...
                function (t, o) {
                    ...
                    for (var u = []; ; ) {
                        ...
                        if ((Xh(u, d), !c)) break;
                        "" === Hh(d[0]) &&
                            (a.lastIndex = Uh(r, Lh(a.lastIndex), h));
                    }
    ...
    kr("search", function (t, e, i) {
        return [
            ...
            function (t) {
                ...
                var s = uu(n, o);
                return (
                    lu(n.lastIndex, r) || (n.lastIndex = r),
                    null === s ? -1 : s.index
                );
            },
        ];
        ...
        Du =
            ...
            ("__proto__" in {}
                ? (function () {
                      ...
                      return function (i, n) {
                          return (
                              Fu(i), _u(n), e ? t(i, n) : (i.__proto__ = n), i
                          );
                      };
                  })()
                : void 0),
        ...
        { target: "Array", proto: !0, forced: !qp },
        {
            splice: function (t, e) {
                ...
                if (((o.length = n), i < n)) {
                    for (a = h; a < c - n; a++)
                        (s = a + i),
                            (r = a + n) in l ? (l[s] = l[r]) : zp(l, s);
                    for (a = c; a > c - n + i; a--) zp(l, a - 1);
                } else if (i > n)
                    for (a = c - n; a > h; a--)
                        (s = a + i - 1),
                            (r = a + n - 1) in l ? (l[s] = l[r]) : zp(l, s);
    ...
    Bg(
        {
            ...
            forced:
                !!(
                    Jg ||
                    ((Vg = Hg(String.prototype, "startsWith")),
                    !Vg || Vg.writable)
                ) && !Jg,
        },
        {
    ...
    var hv = {
            ...
            isEmptyObject: function () {
                var t =
                    arguments.length > 0 && void 0 !== arguments[0]
                        ...
                        : {};
                return (
                    0 === Object.entries(t).length && t.constructor === Object
                );
            },
                        ...
                        (l._id = s.attr("id")),
                            ...
                            s.find(">td,>th").each(function (o, r) {
                                ...
                                (l[p] = s.html().trim()),
                                    ...
                                    (l["_".concat(p, "_class")] =
                                        s.attr("class")),
                                    (l["_".concat(p, "_rowspan")] =
                                        s.attr("rowspan")),
                                    (l["_".concat(p, "_colspan")] =
                                        s.attr("colspan")),
                                    (l["_".concat(p, "_title")] =
                                        s.attr("title")),
                                    (l["_".concat(p, "_data")] =
                                        n.getRealDataAttr(s.data())),
                                    (l["_".concat(p, "_style")] =
                                        s.attr("style"));
                            }),
                            o.push(l);
            ...
            getDetailViewIndexOffset: function (t) {
                return this.hasDetailViewIcon(t) &&
                    "right" !== t.detailViewAlign
                    ? 1
                    : 0;
            },
        ...
        dv = {
            3: {
                ...
                html: {
                    ...
                    searchInput:
                        '<input class="%s%s" type="text" placeholder="%s">',
                    searchButton:
            ...
            4: {
                ...
                html: {
                    ...
                    pageDropdownItem:
                        '<a class="dropdown-item %s" href="#">%s</a>',
            ...
            function t(e) {
                ...
                var n = function () {
                    i.lastCluster !== (i.lastCluster = i.getNum()) &&
                        (i.initDOM(i.rows),
                        i.callback(i.startIndex, i.endIndex));
                };
                                ...
                                ? (i.topOffset &&
                                  ...
                                  e &&
                                      (this.contentEl.scrollTop =
                                          this.cache.scrollTop))
                                : r &&
                                  (this.contentEl.lastChild.style.height =
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            return (
                                ...
                                Math.floor(
                                    this.scrollTop /
                                        (this.clusterHeight - this.blockHeight)
                                ) || 0
                            );
                        },
                    },
            ...
            return (
                r(t, [
                        ...
                        value: function () {
                            ...
                            (this.constants = vv.CONSTANTS),
                                (this.constants.theme =
                                    i.default.fn.bootstrapTable.theme),
                                (this.constants.dataToggle =
                                    this.constants.html.dataToggle ||
                                    "data-toggle");
                            var e = hv.getIconsPrefix(
                                    i.default.fn.bootstrapTable.theme
                                ),
                                o = hv.getIcons(e);
                            "string" == typeof t.icons &&
                                (t.icons = hv.calculateObjectValue(
                                    null,
                                    t.icons
                                )),
                                (t.iconsPrefix =
                                    t.iconsPrefix ||
                                    i.default.fn.bootstrapTable.defaults
                                        .iconsPrefix ||
                                    e),
                            ...
                            var a = t.buttonsPrefix
                                ? "".concat(t.buttonsPrefix, "-")
                                : "";
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            (this.$container = i.default(
                                ...
                                (this.$tableBody =
                                    this.$container.find(".fixed-table-body")),
                            ...
                            if (
                                ...
                                this.$header.find("tr").each(function (t, o) {
                                    ...
                                    a.find("th").each(function (t, e) {
                                        ...
                                        n.push(r),
                                        a.attr("class") &&
                                            e._headerTrClasses.push(
                                                a.attr("class")
                                            ),
                                        a.attr("style") &&
                                            e._headerTrStyles.push(
                                                a.attr("style")
                                            );
                                }),
                        ...
                        value: function () {
                            ...
                            (this.header = {
                                ...
                                this.options.columns.forEach(function (i, o) {
                                    ...
                                    r &&
                                        "right" !== t.options.detailViewAlign &&
                                        a.push(r),
                                ...
                                this.$container
                                    ...
                                    .on("click", ".th-inner", function (e) {
                                        ...
                                        if (
                                            ...
                                            !n
                                                .parent()
                                                .hasClass("bs-checkbox") &&
                                            n.closest(".bootstrap-table")[0] !==
                                                t.$container[0]
                                        )
                                            return !1;
                                        t.options.sortable &&
                                ...
                                ? (this.options.sortStable &&
                                  ...
                                  this.options.customSort
                                      ...
                                      : this.data.sort(function (o, a) {
                                            t.header.sortNames[n] &&
                                                (e = t.header.sortNames[n]);
                                            var r = hv.getItemField(
                                                    o,
                                                    e,
                                                    t.options.escape
                                                ),
                        ...
                        value: function (t) {
                            ...
                            if (
                                ...
                                void 0 === r
                                    ...
                                    : "asc" === r
                                    ? (this.options.sortOrder = this.options
                                          .sortReset
                                          ? "asc" === s
                                              ? "desc"
                                              : void 0
                        ...
                        value: function () {
                                        ...
                                        html: function () {
                                            ...
                                            if (
                                                ...
                                                var i =
                                                    e.getVisibleColumns()
                                                        .length ===
                                                    e.columns.filter(function (
                                                        t
                                                    ) {
                                                        return !e.isSelectionColumn(
                                                            t
                                                        );
                                                    }).length;
                                                t.push(
                            ...
                            for (
                                ...
                                !(
                                    ...
                                    (void 0 !== k && !0 !== k) ||
                                    (o[x] = !0),
                                    o.buttonsOrder.includes(p) ||
                                        o.buttonsOrder.push(p);
                            }
                            var O,
                                C = u(o.buttonsOrder);
                            try {
                            ...
                            if (o.showColumns) {
                                var _ = (t =
                                        this.$toolbar.find(".keep-open")).find(
                            ...
                            if (
                                ...
                                o.showSearchButton
                                    ...
                                    o.showSearchClearButton &&
                                        this.$toolbar
                                            .find(
                                                ".search button[name=clearSearch]"
                                            )
                                            .click(function () {
                                                e.resetSearch();
                                            });
                                ...
                                this.options.searchAccentNeutralise &&
                                    ...
                                    typeof this.filterOptions.filterAlgorithm
                                        ? (this.data = this.options.data.filter(
                                              function (e) {
                                                  return t.filterOptions.filterAlgorithm.apply(
                                                      null,
                                                      [e, n]
                                                  );
                                              }
                            ...
                            if (e.pagination) {
                                ...
                                if (
                                    ...
                                    "string" == typeof this.paginationParts &&
                                        (this.paginationParts =
                                            this.paginationParts
                                                .replace(/\[|\]| |'/g, "")
                                                .split(",")),
                                    "server" !== e.sidePagination &&
                                        (e.totalRows = u.length),
                                    (this.totalPages = 0),
                                    e.totalRows &&
                                        (e.pageSize === e.formatAllRows() &&
                                            ((e.pageSize = e.totalRows),
                                            (h = !0)),
                                        (this.totalPages =
                                            1 +
                                            ~~((e.totalRows - 1) / e.pageSize)),
                                        (e.totalPages = this.totalPages)),
                                    this.totalPages > 0 &&
                                        e.pageNumber > this.totalPages &&
                                        (e.pageNumber = this.totalPages),
                                    (this.pageFrom =
                                        (e.pageNumber - 1) * e.pageSize + 1),
                                    (this.pageTo = e.pageNumber * e.pageSize),
                                    this.pageTo > e.totalRows &&
                                        (this.pageTo = e.totalRows),
                                    this.options.pagination &&
                                        "server" !==
                                            this.options.sidePagination &&
                                    ...
                                    var f = this.paginationParts.includes(
                                        "pageInfoShort"
                                    )
                                ...
                                if (
                                    ...
                                    c.push(
                                        ...
                                        e.pageNumber <
                                            e.paginationSuccessivelySize - 1 &&
                                    ...
                                    c.push(
                                        ...
                                        c.push(
                                            this.constants.html.pagination[1],
                                            "</div>"
                                        );
                                }
                                this.$pagination.html(c.join(""));
                                var y = ["bottom", "both"].includes(
                                    e.paginationVAlign
                                )
                                ...
                                this.$pagination
                                    ...
                                    e.onlyInfoPagination ||
                                        ((a =
                                            this.$pagination.find(
                                                ".page-list a"
                                            )),
                                        (r =
                                            this.$pagination.find(".page-pre")),
                                        (s =
                                            this.$pagination.find(
                                                ".page-next"
                                            )),
                        ...
                        value: function (t) {
                            ...
                            return (
                                e
                                    .parent()
                                    .addClass(
                                        this.constants.classes.dropdownActive
                                    )
                                    .siblings()
                                    .removeClass(
                                        this.constants.classes.dropdownActive
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            if (
                                (t.preventDefault(),
                                this.options.pageNumber !==
                                    +i.default(t.currentTarget).text())
                            )
                                return (
                        ...
                        value: function () {
                            ...
                            this.$body
                                ...
                                .on("mousedown", function (e) {
                                    (t.multipleSelectRowCtrlKey =
                                        e.ctrlKey || e.metaKey),
                                        (t.multipleSelectRowShiftKey =
                                            e.shiftKey);
                                }),
                                this.$body
                                    .find(
                                ...
                                this.header.events.forEach(function (e, n) {
                                    ...
                                    if (o) {
                                        if (
                                            ...
                                            throw new Error(
                                                "Unknown event in the scope: ".concat(
                                                    e
                                                )
                                            );
                                                ...
                                                o.load(a),
                                                    ...
                                                    "server" ===
                                                        ...
                                                        o.options.pageNumber >
                                                            1 &&
                                                        a[
                                                            o.options.totalField
                                                        ] > 0 &&
                                                        !a[o.options.dataField]
                                                            .length &&
                                                        o.updatePagination();
                                            },
                                            error: function (e) {
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            for (
                                ...
                                s[l - 1] = arguments[l];
                            (n = this.options)[t.EVENTS[a]].apply(
                                n,
                                [].concat(s, [this])
                            ),
                                this.$el.trigger(
                                    i.default.Event(a, { sender: this }),
                                    s
                                ),
                            ...
                            if (this.$el.is(":hidden"))
                                ...
                                for (
                                    var c = this.getVisibleFields(),
                                        ...
                                        u = this.$body
                                            .find(
                                                ">tr:not(.no-records-found,.virtual-scroll-top)"
                                            )
                                            .eq(0);
                                    u.length &&
                                    u.find('>td[colspan]:not([colspan="1"])')
                                        .length;
                                ...
                                u.find("> *").each(function (e, n) {
                                    ...
                                    if (
                                        ...
                                        l.length > 1 &&
                                            (l = i.default(h[o[0].cellIndex]));
                                        var u =
                                            l.innerWidth() -
                                            l.find(".fht-cell").width();
                                        l.find(".fht-cell").width(
                                            o.innerWidth() - u
                                        );
                                    }
                    ...
                    },
                    {
                        ...
                        value: function () {
                            if (
                                ...
                                i &&
                                    "right" === this.options.detailViewAlign &&
                                    e.push(i),
                                    this.options.height ||
                        ...
                        value: function () {
                            ...
                            if (this.$el.is(":hidden"))
                                ...
                                for (
                                    ...
                                    a.length &&
                                    a.find('>td[colspan]:not([colspan="1"])')
                                        .length;
                        ...
                        value: function (t) {
                            ...
                            if (
                                ((!(
                                    ...
                                    "function" !=
                                        typeof this.options.filterOptions
                                            .filterAlgorithm &&
                                    hv.isEmptyObject(
                                        this.filterColumnsPartial
                                    )) ||
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            for (
                                var e = 0, i = this.options.data.length - 1;
                                i >= 0;
                                i--
                            ) {
                            ...
                            try {
                                for (n.s(); !(e = n.n()).done; ) {
                                    ...
                                    o.hasOwnProperty("index") &&
                                        ...
                                        (o.hasOwnProperty("replace") &&
                                        o.replace
                                            ? (this.options.data[o.index] =
                                                  o.row)
                                            : i.default.extend(
                                                  this.options.data[o.index],
                                                  o.row
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            t.hasOwnProperty("index") &&
                                ...
                                ((this.options.data[t.index][t.field] =
                                    t.value),
                                !1 !== t.reinit
                        ...
                        value: function (t) {
                            ...
                            (Array.isArray(t) ? t : [t]).forEach(function (t) {
                                var i = t.id,
                                    n = t.field,
                                    o = t.value,
                                    a = e.options.data.indexOf(
                                        e.getRowByUniqueId(i)
                                    );
                                ...
                                !1 !== t.reinit
                                    ...
                                    : this._updateCellOnly(
                                          t.field,
                                          this.options.data.indexOf(
                                              this.getRowByUniqueId(t.id)
                                          )
                                      );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (
                                ...
                                var r = this.$toolbar
                                    .find(
                                        '.keep-open input[type="checkbox"]:not(".toggle-all")'
                                    )
                                    .prop("disabled", !1);
                                t
                                    ? r.prop("checked", t)
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    for (
                                        var r = s(
                                                this
                                                    .multipleSelectRowLastSelectedIndex <
                                                    e
                                                    ? [
                                                          this
                                                              .multipleSelectRowLastSelectedIndex,
                                ...
                                (this.multipleSelectRowCtrlKey = !1),
                                    ...
                                    (this.multipleSelectRowLastSelectedIndex = t
                                        ? e
                                        : -1);
                            }
                            i.prop("checked", t),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            t && t.url && (this.options.url = t.url),
                                t &&
                                    t.pageNumber &&
                                    (this.options.pageNumber = t.pageNumber),
                                t &&
                                    t.pageSize &&
                                    (this.options.pageSize = t.pageSize),
                                this.trigger(
                                    "refresh",
                                    this.initServer(
                                        t && t.silent,
                        ...
                        value: function (t) {
                            ...
                            if (
                                ...
                                !this.options.cardView &&
                                    ...
                                    this.fitFooter(),
                                    this.options.height &&
                                        (e += this.$tableFooter.outerHeight(
                                            !0
                                        ))),
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            (this.filterOptions = hv.isEmptyObject(e)
                                ...
                                (this.filterColumns = hv.isEmptyObject(t)
                                    ? {}
                                    : t),
                                (this.options.pageNumber = 1),
                                this.initSearch(),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            t.hasOwnProperty("field") &&
                                ...
                                ((this.columns[
                                    this.fieldsColumnsIndex[t.field]
                                ].title = this.options.escape
                                    ? hv.escapeHTML(t.title)
                                    : t.title),
                                this.columns[this.fieldsColumnsIndex[t.field]]
                                    .visible &&
                                    (this.$header
                                        .find("th[data-field]")
                                        .each(function (e, n) {
            ...
            return (
                this.each(function (e, a) {
                    ...
                    if ("string" == typeof t) {
                        ...
                        (r = (c = s)[t].apply(c, o)),
                            "destroy" === t &&
                                i.default(a).removeData("bootstrap.table");
                    }
                    s ||
