    ...
    return (function () {
        ...
        function F(e, t, n) {
            ...
            t &&
                ...
                (o =
                    (e.offsetHeight > 0 && H(i.height) / e.offsetHeight) || 1));
        ...
        var je,
            Pe = Le(),
            De = Le({ defaultModifiers: [oe, Ee, ie, D, Ae, ye, Oe, Z, ke] }),
            Ie = Le({ defaultModifiers: [oe, Ee, ie, D] });
        function Ne() {
            return (
                (Ne =
            ...
            wt = function (e, t) {
                ...
                if (n) {
                    var i = 5,
                        ...
                        a = function n(i) {
                            i.target === t &&
                                ((o = !0), t.removeEventListener(nt, n), bt(e));
                        };
                    t.addEventListener(nt, a),
                        setTimeout(function () {
                            o || ct(t);
                        }, r);
                } else bt(e);
            ...
            Rn = (function (e) {
                ...
                function n(e, i) {
                    ...
                    return (
                        ...
                        (r.touchTimeout = null),
                        (r._swipeHelper = null),
                        (r._indicatorsElement = on.findOne(
                            ".carousel-indicators",
                            r._element
                        )),
                        r._addEventListeners(),
                        r._config.ride === Sn && r.cycle(),
                        r
                    );
                }
                return (
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    this._config.keyboard &&
                                        Bt.on(this._element, An, function (t) {
                                            return e._keydown(t);
                                        }),
        ...
        Bt.on(
            ...
            Bt.on(window, Cn, function () {
                var e,
                    t = Je(on.find('[data-bs-ride="carousel"]'));
                try {
                    for (t.s(); !(e = t.n()).done; ) {
                        var n = e.value;
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    if (this._config.parent) {
                                        var e,
                                            t = Je(
                                                this._getFirstLevelChildren(Jn)
                                            );
                                        try {
                                            for (t.s(); !(e = t.n()).done; ) {
                                                var n = e.value,
        ...
        Bt.on(document, Xn, Jn, function (e) {
            ...
            try {
                for (i.s(); !(t = i.n()).done; ) {
                    var r = t.value;
                    ti.getOrCreateInstance(r, { toggle: !1 }).toggle();
                }
            } catch (e) {
                i.e(e);
            } finally {
            ...
            Ti = (function (e) {
                ...
                function i(e, n) {
                    ...
                    return (
                        ...
                        (r._menu =
                            on.next(r._element, mi)[0] ||
                            on.prev(r._element, mi)[0] ||
                            on.findOne(mi, r._parent)),
        ...
        Bt.on(document, di, vi, Ti.dataApiKeydownHandler),
            Bt.on(document, di, mi, Ti.dataApiKeydownHandler),
            Bt.on(document, fi, Ti.clearMenus),
            Bt.on(document, hi, Ti.clearMenus),
            Bt.on(document, fi, vi, function (e) {
        ...
        var Ci = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
                        ...
                        },
                        {
                            ...
                            value: function () {
                                this._resetElementAttributes(
                                    ...
                                    this._resetElementAttributes(Ci, Si),
                                    this._resetElementAttributes(xi, Li);
                            },
                        },
                        {
                            key: "isOverflowing",
                    ...
                    Ue(
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    return (
                                        (e.rootElement = ut(e.rootElement)), e
                                    );
                                },
                            },
                            {
            ...
            ir = "show",
            rr = "modal-static",
            or = { backdrop: !0, focus: !0, keyboard: !0 },
            ar = {
            ...
            sr = (function (e) {
                ...
                function n(e, i) {
                    ...
                    return (
                        Xe(this, n),
                        ((r = t.call(this, e, i))._dialog = on.findOne(
                            ".modal-dialog",
                            r._element
                        )),
                                    ...
                                    if (
                                        ...
                                        "hidden" === n ||
                                            ...
                                            this._queueCallback(function () {
                                                e._element.classList.remove(rr),
                                                    e._queueCallback(
                                                        function () {
        ...
        Bt.on(document, tr, '[data-bs-toggle="modal"]', function (e) {
            ...
            ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
                Bt.one(n, Ui, function (e) {
                    e.defaultPrevented ||
                        Bt.one(n, Yi, function () {
                            ft(t) && t.focus();
                        });
                });
        ...
        Bt.on(document, wr, '[data-bs-toggle="offcanvas"]', function (e) {
            ...
            if (
                ...
                var i = on.findOne(pr);
                i && i !== n && Or.getInstance(i).hide(),
                    Or.getOrCreateInstance(n).toggle(this);
            }
        }),
            ...
            Bt.on(window, br, function () {
                var e,
                    t = Je(
                        on.find("[aria-modal][class*=show][class*=offcanvas-]")
                    );
                try {
                    for (t.s(); !(e = t.n()).done; ) {
                        var n = e.value;
                        "fixed" !== getComputedStyle(n).position &&
                            Or.getOrCreateInstance(n).hide();
                    }
                } catch (e) {
                    t.e(e);
                } finally {
        ...
        var Tr = new Set([
            ...
            Sr = function (e, t) {
                ...
                return t.includes(n)
                    ? !Tr.has(n) ||
                          Boolean(Cr.test(e.nodeValue) || xr.test(e.nodeValue))
                    : t
                          .filter(function (e) {
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    return (
                                        ...
                                        (this.tip &&
                                            this.tip.classList.contains(Mr))
                                    );
                                },
                            },
                            {
                                ...
                                value: function () {
                                    return (
                                        this.tip &&
                                        this.tip.classList.contains(Hr)
                                    );
                                },
                            },
                            {
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    var e,
                                        t = Je(
                                            on.find(eo, this._config.target)
                                        );
                                    try {
                                        for (t.s(); !(e = t.n()).done; ) {
                                            var n = e.value;
        ...
        Bt.on(window, Jr, function () {
            var e,
                t = Je(on.find('[data-bs-spy="scroll"]'));
            try {
                for (t.s(); !(e = t.n()).done; ) {
                    var n = e.value;
        ...
        var ao = ".".concat("bs.tab"),
            ...
            To = "."
                .concat(yo, '[data-bs-toggle="tab"], .')
                .concat(yo, '[data-bs-toggle="pill"], .')
                .concat(yo, '[data-bs-toggle="list"]'),
            Co = (function (e) {
                Be(n, e);
                var t = Fe(n);
                function n(e) {
                    ...
                    return (
                        ...
                        i._parent
                            ? (i._setInitialAttributes(
                                  i._parent,
                                  i._getChildren()
                              ),
                              Bt.on(i._element, ho, function (e) {
                                  return i._keydown(e);
                              }),
                              i)
                            : Re(i)
                                    ...
                                    if (!this._elemIsActive(e)) {
                                        var t = this._getActiveElem(),
                                            n = t
                                                ...
                                                : null;
                                        Bt.trigger(e, lo, { relatedTarget: t })
                                            .defaultPrevented ||
        ...
        Bt.on(document, fo, Eo, function (e) {
            ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
                dt(this) || Co.getOrCreateInstance(this).show();
        }),
                        ...
                        [
                            {
                                ...
                                value: function () {
                                    ...
                                    Bt.trigger(this._element, No)
                                        ...
                                        vt(this._element),
                                        this._element.classList.add(Bo, Wo),
                                        this._queueCallback(
                                            function () {
                                                e._element.classList.remove(Wo),
                                                    Bt.trigger(e._element, Mo),
