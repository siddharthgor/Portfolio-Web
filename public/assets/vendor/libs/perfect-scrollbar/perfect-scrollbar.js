                    ...
                    t.exports = (function () {
                        ...
                        function f(t, e) {
                            u[e] = setTimeout(function () {
                                return (
                                    t.isAlive &&
                                    t.element.classList.remove(h.scrolling(e))
                                );
                        ...
                        function X(t) {
                            ...
                            (t.containerWidth = Math.round(n.width)),
                                ...
                                t.containerWidth +
                                    t.settings.scrollXMarginOffset <
                                    t.contentWidth
                                ...
                                t.containerHeight +
                                    t.settings.scrollYMarginOffset <
                                    t.contentHeight
                            ...
                            R = function (i, n) {
                                ...
                                (this.scrollbarXBottom = parseInt(
                                    ...
                                    (this.railBorderXWidth =
                                        Y(b.borderLeftWidth) +
                                        Y(b.borderRightWidth)),
                                    e(this.scrollbarXRail, {
                                        display: "block",
                                    }),
                                    (this.railXMarginWidth =
                                        Y(b.marginLeft) + Y(b.marginRight)),
                                ...
                                (this.scrollbarYRight = parseInt(v.right, 10)),
                                    ...
                                    (this.railBorderYWidth =
                                        Y(v.borderTopWidth) +
                                        Y(v.borderBottomWidth)),
                                    e(this.scrollbarYRail, {
                                        display: "block",
                                    }),
                                    (this.railYMarginHeight =
                                        Y(v.marginTop) + Y(v.marginBottom)),
                                    ...
                                    (this.isAlive = !0),
                                    this.settings.handlers.forEach(function (
                                        t
                                    ) {
                                        return L[t](l);
                                    }),
