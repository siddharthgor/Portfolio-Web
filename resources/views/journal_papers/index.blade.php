                        ...
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <a href="{{ route('journal_papers.create') }}"
                                        class="btn btn-sm btn-primary float-right mt-3">Add
                                        Journal Papers</a>
                                    <table id="table" data-toggle="table" data-url="/admin/papers/journal_papers/list"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-sortable="true" data-visible="true"data-field="impact_factor">
                                                    Impact Factor </th>
                                                <th data-visible="true"data-field="link">Link</th>
                                                <th data-sortable="true" data-visible="true"data-field="year">Year</th>
                                            </tr>
                                        </thead>
                                    </table>
