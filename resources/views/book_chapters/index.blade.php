                        ...
                        <div class="col-sm-12">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <a href="{{ route('books_chapters.create') }}"
                                        class="btn btn-sm btn-primary float-right mt-3">Add
                                        Book/Book Chapter</a>
                                    <table id="table" data-toggle="table" data-url="/admin/papers/books_chapters/list"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-sortable="true" data-visible="true"data-field="authors">
                                                    Authors </th>
                                                <th data-sortable="true" data-visible="true"data-field="book">
                                                    Book </th>
